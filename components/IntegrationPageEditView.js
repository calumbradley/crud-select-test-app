...
const IntegrationPageEditView = ({ formik, showTable }) => {
  const { values } = formik;

  return (
    <div>
      <Typography sx={{ mt: 3 }}>Edit / View Page</Typography>
      {showTable && (
...
IntegrationPageEditView.propTypes = {
  formik: PropTypes.object.isRequired,
  showTable: PropTypes.bool.isRequired,
};

export default IntegrationPageEditView;
